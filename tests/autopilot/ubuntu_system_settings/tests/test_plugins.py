...
class SystemSettingsTestCases(UbuntuSystemSettingsTestCase):
    ...
    def test_network_category(self):
        ...
        category = self.main_window.select_single(objectName='categoryGrid-network')
    ...
    def test_personal_category(self):
        ...
        category = self.main_window.select_single(objectName='categoryGrid-personal')
        self.assertThat(category, NotEquals(None))
    ...
    def test_system_category(self):
        ...
        category = self.main_window.select_single(objectName='categoryGrid-system')
        self.assertThat(category, NotEquals(None))
    ...
    def test_cellular_plugin(self):
        ...
        plugin = self.main_window.select_single(objectName='entryComponent-cellular')
        self.assertThat(plugin, NotEquals(None))

    def test_bluetooth_plugin(self):
        """ Checks whether the Bluetooth plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-bluetooth')
        self.assertThat(plugin, NotEquals(None))

    def test_background_plugin(self):
        """ Checks whether the Background plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-background')
        self.assertThat(plugin, NotEquals(None))

    def test_sound_plugin(self):
        """ Checks whether the Sound plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-sound')
        self.assertThat(plugin, NotEquals(None))

    def test_language_plugin(self):
        """ Checks whether the Language plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-language')
        self.assertThat(plugin, NotEquals(None))

    def test_accounts_plugin(self):
        """ Checks whether the Accounts plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-online-accounts')
        self.assertThat(plugin, NotEquals(None))

    def test_timedate_plugin(self):
        """ Checks whether the Time & Date plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-time-date')
        self.assertThat(plugin, NotEquals(None))

    def test_security_plugin(self):
        """ Checks whether the Security plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-security-privacy')
        self.assertThat(plugin, NotEquals(None))

    def test_updates_plugin(self):
        """ Checks whether the Updates plugin is available """
        plugin = self.main_window.select_single(objectName='entryComponent-system-update')
        self.assertThat(plugin, NotEquals(None))
...
class SystemSettingsUpowerTestCases(UbuntuSystemSettingsUpowerTestCase):
    ...
    def test_no_battery_plugin_without_battery(self):
        ...
        self.assertThat(lambda: self.main_window.select_single(objectName='entryComponent-battery'),
    ...
    def test_battery_plugin_battery_hotplugging(self):
        ...
        plugin = self.main_window.select_single(objectName='entryComponent-battery')
        self.assertThat(plugin, NotEquals(None))
