...
#ifndef SYSTEM_SETTINGS_RESET_PLUGIN_H
#define SYSTEM_SETTINGS_RESET_PLUGIN_H

#include <QObject>
#include <SystemSettings/PluginInterface>

class ResetPlugin: public QObject, public SystemSettings::PluginInterface2
{
    Q_OBJECT
...
#endif // SYSTEM_SETTINGS_RESET_PLUGIN_H
