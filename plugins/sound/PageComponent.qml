...
import Ubuntu.Components.ListItems 1.3 as OldListItem
    ...
    Flickable {
        ...
        Column {
            ...
            ListItem {
                ...
                SlotsLayoutCpp {
                    id: silentLayout
                    titleItem.text: i18n.tr("Silent Mode")
                    Switch {
                        id: silentModeSwitch
            ...
            ListItem {
                ...
                SlotsLayoutCpp {
                    id: highVolumeLayout
                    titleItem.text: i18n.tr("High volume can damage your hearing.")
                }
            }
            ...
            ListItem {
                ...
                SlotsLayoutCpp {
                    id: ringtoneLayout
                    titleItem.text: i18n.tr("Ringtone")
