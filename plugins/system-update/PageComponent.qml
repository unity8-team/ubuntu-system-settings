...
ItemPage {
    ...
    Column {
        ...
        ListView {
            ...
            height: root.height - configuration.height -
                    (installAllButton.visible ? installAllButton.height : 0) -
                    (credentialsNotification.visible ? credentialsNotification.height : 0)
