...
class AboutTestCase(AboutBaseTestCase):
    ...
    def test_about_page(self):
        ...
        self.assertThat(
            self.system_settings.main_view.about_page,
            NotEquals(None))
        self.assertThat(
            self.system_settings.main_view.about_page.title,
...
class StorageTestCase(StorageBaseTestCase):
    ...
    def test_storage_page(self):
        ...
        self.assertThat(
            self.system_settings.main_view.storage_page,
            NotEquals(None))
...
class LicenseTestCase(LicenseBaseTestCase):
    ...
    def test_licenses_page(self):
        """ Check whether Storage page is available """
        self.assertThat(
            self.system_settings.main_view.licenses_page,
            NotEquals(None))
