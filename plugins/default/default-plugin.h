...
#ifndef SYSTEM_SETTINGS_DEFAULT_PLUGIN_H
#define SYSTEM_SETTINGS_DEFAULT_PLUGIN_H

#include <QObject>
#include <SystemSettings/PluginInterface>

class DefaultPlugin: public QObject, public SystemSettings::PluginInterface
{
    Q_OBJECT
...
#endif // SYSTEM_SETTINGS_DEFAULT_PLUGIN_H
