 ...
 * Command line was: qdbusxml2cpp -N -p nm_settings_connection_proxy.h -v nm-settings-connection-introspection.xml
 *
...
#ifndef NM_SETTINGS_CONNECTION_PROXY_H_1402664031
#define NM_SETTINGS_CONNECTION_PROXY_H_1402664031
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QMap<QString, QVariantMap> > GetSecrets(const QString &setting_name)
    {
        QList<QVariant> argumentList;
    ...
    inline QDBusPendingReply<QMap<QString, QVariantMap> > GetSettings()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QLatin1String("GetSettings"), argumentList);
    }

    inline QDBusPendingReply<> Update(const QMap<QString, QVariantMap> &properties)
    {
        QList<QVariant> argumentList;
